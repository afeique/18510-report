...
\begin{figure}[ht]
	...
	\begin{tabular}{ c | l }
		...
		$w_c$ & central (apex) deflection, equal to $w(r=0)$ \\
...
When sound pressure impinges upon the membrane, it oscillates with the pressure according to its mechanical properties. Fig. \ref{fig:MembraneDeflection} and Fig. \ref{tab:MembraneSymbols} show modeled parabolic deflection and definitions for the symbolic parameters. The modeled parabolic deflection assumes sound pressure is uniformly distributed across the face of the membrane. This produces purely vertical membrane oscillation along the $z$-axis in cylindrical coordinates, with the greatest deflection $w_c$ occurring at the center of the membrane at the point with the largest moment arm relative to the circumference.

The deflection at any radius $r$ in cylindrical coordinates is described by\supercite{schomburg}:

\begin{figure}[ht]
	\begin{equation}
		w(r) = w_c\left(1-\frac{r^2}{R_M^2}\right)
		\label{eq:Deflection}
	\end{equation}
\end{figure}
