...
\begin{figure}[ht]
	...
	\begin{equation}
		\begin{split}
		&\int_A dC = \int_A \frac{\epsilon_0\,dA}{h_0-w(r)} \\[0.75em]
							= &\int_0^{R_M}{\int_0^{2\pi}{\frac{\epsilon_0 r}{h_0-w(r)}\,d\theta\,dr}} \\[0.75em]
						C = &\frac{\epsilon_0\pi R_M^2}{w_0} \mathrm{ln}\left(\frac{h_0}{h_0-w_0}\right)
		\end{split}
